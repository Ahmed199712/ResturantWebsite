...
<div class="modal fade createNewAdmin" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">

      <!-- Start Form -->
      <form id="createAdminForm" action="{{ url('/admins/store') }}" method="POST" enctype="multipart/form-data">
        {{ csrf_field() }}

            <div class="modal-header" style="font-size:20px">
                <b style="color:#3c8dbc">{{ trans('backend.admins') }}</b> - {{ trans('backend.addnew') }}
            </div>
