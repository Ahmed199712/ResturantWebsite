...
<div class="modal fade editNewAdmin" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">

      <!-- Start Form -->
      <form id="updateAdminForm" action="{{ route('admin.admins.update') }}" method="POST" enctype="multipart/form-data">
        {{ csrf_field() }}
        ...
        <input type="hidden" name="userID" id="userID">
            ...
            <div class="modal-header" style="font-size:20px">
                <b style="color:#3c8dbc">{{ trans('backend.admins') }}</b> - {{ trans('backend.edit') }}
            </div>
