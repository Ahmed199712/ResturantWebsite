...
<div class="modal fade createNewTest" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">

      <!-- Start Form -->
      <form id="createTestForm" action="{{ route('test.store') }}" method="POST" enctype="multipart/form-data">
        {{ csrf_field() }}
              ...
              <div class="row">
                <div class="col-md-5">
                  <div class="form-group">
                    ...
                    <img style="margin:5px 0;width:100%;height:286px" class="img-thumbnail" id="testImagePreview" src="{{ asset('uploads/avatars/default.png') }}">
                    <input type="file" id="testImage" name="image" class="form-control">
                  </div>
                </div>
                <div class="col-md-7">
